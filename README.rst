...
This is a Python package for interacting with `MPG.PuRe <https://pure.mpg.de>`_ via the `PubMan REST API <https://pure.mpg.de/rest/swagger-ui.html>`_. A minimal documentation can be found on `Read the Docs <https://pybman.readthedocs.io/>`_.
